...
// TODO: Clean up the #include mess with includes that are not present in the
//       root directory of AI.
...
private:
  ...
  battleai::CBattleLogic* battle_logic_;
	generalai::CGeneralAI   general_AI_;
  Priorities*             priorities_;
	::CondSh<BattleState>   state_; //are we engaged into battle?
...
public:
  ...
  // askID.
	...
	virtual void battlefieldPrepared(int battlefieldType,
